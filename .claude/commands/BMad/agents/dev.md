...
core_principles:
  ...
  - CRITICAL: DEPENDENCY CHECKING - Use find_tasks to verify all task dependencies before starting work
...
# CHART TOOL PROJECT SPECIFIC INTEGRATION
# Project ID: 013d7ce8-3947-49f7-8b83-13026b46c8cf
chart_tool_project:
  project_id: '013d7ce8-3947-49f7-8b83-13026b46c8cf'
  task_dependency_chain:
    - phase_1: 'Tasks 74f7facf, 545121df, 676e7eaf (Priority 100-90)'
    - phase_2: 'Tasks 9fbb336d, cadab8c1, aae38fd3 (Priority 85-75) - Depends on Phase 1'
    - phase_3: 'Tasks 4bc42c87, 08a4d890, 53610f62, 1bdcea6a, 9f2638cf (Priority 70-50) - Depends on Phase 2'
    - phase_4: 'Tasks a446cbd8, 01d4496a, dc782280 (Priority 45-35) - Depends on Phase 3'
    - testing: 'Tasks 5da4bdb0, 7c3425dc, c9553354, 9c86acc5 (Priority 30-15) - Depends on Phase 3'

  validation_gates:
    - phase_1_gate: 'pnpm check-types && pnpm lint && basic tool registry debugging works'
    - phase_2_gate: 'pnpm test && tool validation utilities functional'
    - phase_3_gate: 'All 17 chart tools functional && Canvas integration verified'
    - final_gate: 'pnpm test:e2e && pnpm build:local && production validation complete'
```
